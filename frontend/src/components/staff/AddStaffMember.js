...
export default function AddStaffMember() {
  ...
  function sendData(e) {
    ...
    axios
      .post("http://localhost:8070/staffmember/addsmember", newStaffMember)
      .then(() => {
        alert("member Added");
        setMName("");
        setMEmail("");
    ...
    <div>
      <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
          ...
          <h1 class="card-title" style={{ fontSize: "90px" }}>
            <b>ADD NEW</b> <b class="text-success">STAFF</b>
          </h1>
          <br></br>
          <br></br>
          <br></br>
      ...
      <div>
        <div
          ...
          style={{ width: "1000px", backgroundColor: "#E0E0E0" }}
        >
          <div class="card-body">
            <br></br>
            ...
            <form class="row g-3 was-validated">
              <div class="col-md-6">
                ...
                <div className="invalid-feedback">
                  {error && mname.length <= 0 ? (
                    <lable class="text" style={{ color: "#FF0000" }}>
                      Name can't be empty!
                    </lable>
                  ) : (
                    ""
              ...
              <div class="col-md-6">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // Replace 'V' or 'v' with an empty string
                ...
                <div className="invalid-feedback">
                  {error && mnic.length <= 0 ? (
                    <label class="text" style={{ color: "#FF0000" }}>
                      NIC can't be empty!
                    </label>
                  ) : (
                    ""
              ...
              <div class="col-md-6">
                ...
                <div className="invalid-feedback">
                  {error && mwdays.length <= 0 ? (
                    <lable class="text" style={{ color: "#FF0000" }}>
                      Working Days can't be empty!
                    </lable>
                  ) : (
                    ""
                  )}
